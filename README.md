...
3. [Book Recommendation Engine using KNN](https://github.com/phyulwin/Machine-Learning-with-Python-Projects/blob/main/project-solutions/Phyu_Lwin_Copy_of_fcc_book_recommendation_knn.ipynb)
